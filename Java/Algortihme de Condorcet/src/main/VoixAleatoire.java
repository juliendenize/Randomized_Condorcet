...
public class VoixAleatoire extends Voix {
	 ...
	 * <p>
	 * 	A la construction d'un objet Voix, l'idVotant et nbAlternatives sont fixées par le constructeur de la classe mère {@link Voix#Voix(int, int)}.<br>
	 * 	La génération de rangAlternatives est dans la méthode {@link VoixAleatoire#genererVoix()}.
	 * </p><br>
	 * @param idVotant 
	 * 				L'ID du votant.
